import { ButtonComponent, SocialMediaButton } from '@/app/components';
      ...
      <div className="flex flex-col justify-center max-w-4xl mx-auto py-16 px-14 sm:px-6 lg:px-8">
        ...
        <div className="max-w-xl mx-auto">
          <p className="mt-10 text-gray-800 text-center text-xl lg:text-3xl">
            <a
              href="#"
              className="font-medium text-black hover:underline origin-left transition-all duration-500 ease-in-out"
            >
